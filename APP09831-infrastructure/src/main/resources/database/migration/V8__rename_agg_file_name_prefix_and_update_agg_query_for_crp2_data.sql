UPDATE public.aggregation_configuration set file_name_prefix='RETAIL', last_updated_datetime=CURRENT_TIMESTAMP
      WHERE file_name_prefix = 'Retail_Transaction_Aggregation';

UPDATE public.aggregation_configuration set file_name_prefix='RESTAURANT', last_updated_datetime=CURRENT_TIMESTAMP
      WHERE file_name_prefix = 'Restaurant_Transaction_Aggregation';

UPDATE public.aggregation_configuration set file_name_prefix='MARKETPLACE', last_updated_datetime=CURRENT_TIMESTAMP
      WHERE file_name_prefix = 'Marketplace_Transaction_Aggregation';

UPDATE public.aggregation_configuration set file_name_prefix='PROMOTION', last_updated_datetime=CURRENT_TIMESTAMP
...
set aggregation_query =
    'select STRING_AGG(cast(tld.transaction_line_id as TEXT), '','') as transaction_line_ids,
     	...
     	null as "REFUND_ADJUSTMENT_REASON_CODE",
     	sum(RESTAURANT_TIP_AMOUNT) as "RESTAURANT_TIP_AMOUNT",
