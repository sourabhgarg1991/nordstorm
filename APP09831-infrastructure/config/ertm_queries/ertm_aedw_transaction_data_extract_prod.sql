...
union all
	...
	from
		PRD_AW_VWS.SLS_TRN_HDR_OPR,
		PRD_AW_VWS.sls_trn_dtl_opr
	where
		SLS_TRN_HDR_OPR.SLS_TRAN_OPR_NUM = sls_trn_dtl_opr.SLS_TRAN_OPR_NUM
        and SI_TRANS_TYP_CD <> 'VOID'
        and SATI_TRANS_STS_CD <> 'D'
        and DATA_SRC_CD <> 'RPOS'
        and NOT EXISTS ( SELECT 1 FROM PRD_AW_VWS.SLS_TRN_HDR_OPR as V where
		...
		and SLS_TRN_HDR_OPR.PROCESS_DT BETWEEN DATE '2025-09-22' AND DATE '2025-09-26'
		and sls_trn_dtl_opr.PROCESS_DT BETWEEN DATE '2025-09-22' AND DATE '2025-09-26'
union all
	select
		CAST(SLS_TRN_HDR_OPR.SLS_TRAN_OPR_NUM AS VARCHAR(128)) as SOURCE_REFERENCE_TRANSACTION_ID,
		CAST(SCH_TRANS_DT AS VARCHAR(128)) as TRANSACTION_DATE,
	...
	where
		...
		and SLS_TRN_HDR_OPR.PROCESS_DT BETWEEN DATE '2025-09-22' AND DATE '2025-09-26'
		and sls_trn_tndr_opr.PROCESS_DT BETWEEN DATE '2025-09-22' AND DATE '2025-09-26'
) as data
